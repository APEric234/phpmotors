...
<?php 
  ...
  <input type='password' id='newPassword' name='newPassword' minlength="8" oninvalid="this.setCustomValidity('must have 1 number one uppper case character and be at least 8 digits')" oninput="this.setCustomValidity('')" pattern="^(?=.*?[A-Z])(?=.*?\d).*"  required><br>
